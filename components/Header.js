...
import { removeAllHiddenArticle } from '../reducers/hiddenArticles';  // Assurez-vous que le chemin est correct
...
function Header() {
	...
	const handleRegister = () => {
		fetch('https://morningnews-backend-topaz.vercel.app/users/signup', {
			method: 'POST',
	...
	const handleConnection = () => {
		...
		fetch('https://morningnews-backend-topaz.vercel.app/users/signin', {
			method: 'POST',
			headers: { 'Content-Type': 'application/json' },
	...
	const handleShowAllArticles = () => {
		dispatch(removeAllHiddenArticle());
	};
	...
	return (
		<header className={styles.header}>
			...
			<div className={styles.linkContainer}>
				...
				<FontAwesomeIcon onClick={handleShowAllArticles} className={styles.eyeIcon} icon={faEye} />
			</div>
